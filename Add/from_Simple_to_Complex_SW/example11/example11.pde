...
{ 
  ...
  swR3.speed = 0.66 * 0.66;
  swR2.speed = 0.66;

  swR1.cb = color(0); swR1.c = color(85); swR1.ci = color(255, 0, 55); swR1.contrast = 1.0;
  swR2.cb = color(0); swR2.c = color(65); swR2.ci = color(255, 0, 55); swR2.contrast = 1.0;
  swR3.cb = color(0); swR3.c = color(45); swR3.ci = color(255, 0, 55); swR3.contrast = 1.0;
}
